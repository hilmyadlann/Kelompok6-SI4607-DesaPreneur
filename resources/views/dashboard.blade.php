...
<head>
  ...
  <style>
    ...
    .slider-container {
      display: flex;
      overflow: hidden;
      width: 100%; /* fixed: removed extra px */
    }
...
<body class="antialiased">
  <div class="min-h-screen bg-white">
    ...
    <header class="absolute inset-x-0 top-0 z-40">
      <nav
        class="flex items-center justify-between p-5 lg:px-20 bg-green-500"
        aria-label="Global"
      >
        ...
        <div class="absolute left-2/4 transform -translate-x-2/4">
          <!-- Missing content for search? Add or remove this div as needed -->
        </div>
        ...
        <div class="flex items-center space-x-4">
          ...
          <div class="dropdown dropdown-end relative" id="profileDropdown">
            <span
              tabindex="0"
              role="button"
              class="cursor-pointer text-sm font-semibold text-white flex items-center justify-between"
            ...
            >
              ...
              <svg
                ...
                class="h-5 w-5 text-white arrow-down"
                viewBox="0 0 20 20"
                fill="currentColor"
              >
                <path
            ...
            <ul
              tabindex="0"
              class="mt-3 z-[1] p-2 shadow menu menu-sm dropdown-content bg-base-100 rounded-box w-52 hidden"
            >
              <li>
                <a
          ...
          @endphp
          <a
            href="{{ $existingUmkm ? route('toko', $existingUmkm->id) : route('umkms.create') }}"
            class="text-sm font-semibold leading-6 text-white flex items-center space-x-2"
          >
            <img
    ...
    <div class="relative">
      ...
      <div
        class="w-full bg-green-700 pt-16 pb-16 px-4 text-white text-center animate__animated animate__fadeInDown shadow-md mt-16"
      >
        ...
        <p class="text-xl font-semibold leading-relaxed">
          Website <span class="text-yellow-400">Desa</span
          ><span class="text-white">Preneur Kabupaten Bandung</span
          ><br />
    ...
    <section>
      <div
        id="about-section"
        class="py-8 px-4 md:px-6 lg:px-8 w-full grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4"
      >
        <!-- Makanan dan Minuman -->
        <a
          href="{{ route('dashboard.category', ['category' => 'Makanan dan Minuman']) }}#products"
          class="h-full"
        >
          <div
            class="bg-green-300 rounded-lg shadow-md hover:shadow-xl transition duration-300 flex flex-col items-center justify-center hover:bg-green-500 active:bg-green-600 h-full"
          >
            <div class="p-4 text-center">
              <img
                src="{{ asset('images/diet 1.png') }}"
                alt="Logo 1"
                class="h-12 w-12 mb-2 mx-auto"
              />
        ...
        <!-- Kerajinan Tangan -->
        <a
          href="{{ route('dashboard.category', ['category' => 'Kerajinan Tangan']) }}#products"
          class="h-full"
        >
          <div
            class="bg-green-300 rounded-lg shadow-md hover:shadow-xl transition duration-300 flex flex-col items-center justify-center hover:bg-green-500 active:bg-green-600 h-full"
          >
            <div class="p-4 text-center">
              <img
                src="{{ asset('images/artisanal 1.png') }}"
                alt="Logo 2"
                class="h-12 w-12 mb-2 mx-auto"
              />
        ...
        <a
          href="{{ route('dashboard.category', ['category' => 'Kebutuhan Sehari-hari']) }}#products"
          class="h-full"
        >
          <div
            class="bg-green-300 rounded-lg shadow-md hover:shadow-xl transition duration-300 flex flex-col items-center justify-center hover:bg-green-500 active:bg-green-600 h-full"
        ...
        <!-- Pakaian -->
        <a
          href="{{ route('dashboard.category', ['category' => 'Pakaian']) }}#products"
          class="h-full"
        >
          <div
            class="bg-green-300 rounded-lg shadow-md hover:shadow-xl transition duration-300 flex flex-col items-center justify-center hover:bg-green-500 active:bg-green-600 h-full"
          >
            <div class="p-4 text-center">
              <img
                src="{{ asset('images/clothes 1.png') }}"
                alt="Logo 4"
                class="h-12 w-12 mb-2 mx-auto"
              />
        ...
        <!-- Lainnya -->
        <a
          href="{{ route('dashboard.category', ['category' => 'Lainnya']) }}#products"
          class="h-full"
        >
          <div
            class="bg-green-300 rounded-lg shadow-md hover:shadow-xl transition duration-300 flex flex-col items-center justify-center hover:bg-green-500 active:bg-green-600 h-full"
    ...
    <section>
      <div
        id="system-section"
        class="h-full py-8 px-8 mx-auto md:px-12 lg:px-12 max-w-7xl"
      >
        ...
        <div
          class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 lg:gap-6 py-6 px-4 md:px-6"
        >
          @if (isset($category))
          ...
          <div class="mb-8">
            <a href="{{ route('products.show', $product) }}">
              <div
                class="bg-white rounded-lg shadow-lg overflow-hidden h-full"
              >
    ...
    <section>
      <div
        id="stats-section"
        class="pt-8 pb-2 px-4 mx-auto md:px-8 lg:px-6 max-w-7xl"
      >
        <div class="shadow-xl rounded-lg">
          @if (isset($desas))
          <form action="{{ route('umkms.by-desa') }}#umkms" method="GET">
            <div
              class="flex justify-center items-center space-x-2 py-4 px-6 bg-white rounded-lg shadow-md w-full max-w-2xl mx-auto"
            >
              <select
                id="desaSelect"
                name="desa_id"
          ...
          <div
            id="umkms"
            class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 lg:gap-6 py-6 px-4 md:px-6 scroll-animation"
          >
            ...
            <div class="bg-white rounded-lg shadow-md p-4 w-full md:w-auto lg:w-full">
              ...
              <div class="mt-2">
                ...
                <img
                  src="{{ asset('storage/' . $umkm->products->first()->images->first()->image) }}"
                ...
                <div>
                  ...
                  <p>
                    Rp {{ number_format($umkm->products->first()->price, 2, ',', '.') }}
                  </p>
                </div>
                <a
                  href="{{ route('umkms.detail', $umkm->id) }}"
          ...
          <div class="text-center mb-0">
            <p class="text-xl italic font-bold text-gray-500">
              Toko UMKM pada Desa {{ \App\Models\Desa::find($desaId)->nama_desa ?? '' }}
              belum tersedia
            </p>
          </div>
          @endif
