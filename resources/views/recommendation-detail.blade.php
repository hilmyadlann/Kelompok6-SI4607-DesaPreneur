...
<body>
    ...
    <a href="#" 
        ...
        class="bg-white text-black border border-black px-3 py-2 rounded-md flex items-center space-x-2 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none not-liked">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 heart-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                <path d="M20.84 4.42a5.5 5.5 0 0 0-7.78 0L12 5.34l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78L12 21l8.84-8.84a5.5 5.5 0 0 0 0-7.78z" />
        class="bg-white text-black border border-black px-3 py-5 rounded-md flex items-center space-x-2 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none">
    ...
    <!-- Fonts -->
        ...
        <nav class="flex items-center justify-between p-1 lg:px-5 bg-green-500 row-gap: 0px;" aria-label="Global">
