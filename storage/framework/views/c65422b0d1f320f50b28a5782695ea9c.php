<header class="absolute inset-x-0 top-0 z-40">
    <nav class="flex items-center justify-between p-5 lg:px-20 bg-green-500 row-gap: 0px;" aria-label="Global">
        <div class="flex items-center">
            <a href="<?php echo e(route('dashboard')); ?>" class="p-1 mr-1">
                <img class="h-10 w-auto" src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo">
            </a>
        </div>
        <div class="absolute left-2/4 transform -translate-x-2/4">
            <form action="<?php echo e(route('search')); ?>" class="flex items-center bg-white rounded-lg" method="GET">
        ...
        <div class="dropdown dropdown-end" id="profileDropdown">
            <span tabindex="0" role="button" class="cursor-pointer text-sm font-semibold text-white flex items-center justify-between" onclick="toggleDropdown()">
                <span class="flex items-center">
                    <img src="<?php echo e(asset('images/akun.png')); ?>" class="w-6 h-6 mr-1" alt="Profile Icon">
            ...
            <ul tabindex="0" class="mt-3 z-[1] p-2 shadow menu menu-sm dropdown-content bg-base-100 rounded-box w-52" style="display: none;">
                <li>
                    <a class="justify-between text-white" href="<?php echo e(route('profile.show')); ?>">
                        Profile
                    </a>
                </li>
                <li>
        ...
        <?php
        $existingUmkm = auth()->check()
        ? Auth::user()->umkms()->where('disetujui', true)->first()
        : null;
        ?>
...
<?php /**PATH C:\Users\Aldo Wardana\Downloads\DesaPreneur\DesaPreneur\resources\views/navigation-menu.blade.php ENDPATH**/ ?>