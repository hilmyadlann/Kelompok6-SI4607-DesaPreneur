                ...
                <div class="bg-white p-6 rounded shadow mb-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <div class="relative text-gray-600">
                            <input type="search" id="search-umkm-pendaftar" placeholder="Cari UMKM..."
                                class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 pr-10">
                            <button type="submit" id="search-umkm-pendaftar-btn" class="absolute right-0 top-0 mt-3 mr-4">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody id="table-body-umkm-pendaftar" class="bg-white divide-y divide-gray-200">
                                <?php $__empty_1 = true; $__currentLoopData = $umkmPendaftar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $umkm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr id="umkm-row-<?php echo e($index); ?>" class="umkm-row">
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap">
                                        <a href="<?php echo e(route('admin.umkm.show', $umkm)); ?>" class="bg-blue-500 text-white px-4 py-1 rounded hover:bg-blue-600 block mb-2">Lihat Detail</a>
                                        <button type="button" onclick="confirmSetujui('<?php echo e($umkm->id); ?>')" class="bg-green-500 text-white px-4 py-1 rounded hover:bg-green-600 block mb-2">Setujui</button>
                                        <form id="setujui-form-<?php echo e($umkm->id); ?>" action="<?php echo e(route('admin.umkm.setujui', $umkm)); ?>" method="POST" class="hidden">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PUT'); ?>
                                        </form>
                                        <button type="button" onclick="confirmTolak('<?php echo e($umkm->id); ?>')" class="bg-red-500 text-white px-4 py-1 rounded hover:bg-red-600 block">Tolak</button>
                                        <form id="tolak-form-<?php echo e($umkm->id); ?>" action="<?php echo e(route('admin.umkm.tolak', $umkm)); ?>" method="POST" class="hidden">
                                            <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\Users\Aldo Wardana\Downloads\DesaPreneur\DesaPreneur\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>